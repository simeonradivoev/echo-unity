...
namespace ThisOtherThing.UI
{
    public class GeoUtils
    {
        ...
        public static readonly Vector4 UITangent = new(1.0f, 0.0f, 0.0f, -1.0f);
        ...
        public static void SetUnitPositionData(ref UnitPositionData unitPositionData, int resolution, float baseAngle = 0.0f, float direction = 1.0f)
        {
            ...
            if (unitPositionData.UnitPositions == null || unitPositionData.UnitPositions.Length != resolution)
            {
                ...
                for (var i = 0; i < unitPositionData.UnitPositions.Length; i++)
                {
            ...
            needsUpdate |= baseAngle != unitPositionData.LastBaseAngle || direction != unitPositionData.LastDirection;

            if (needsUpdate)
            {
                var angleIncrement = TwoPI / resolution;
        ...
        {
            var diff = (angle2 - angle1 + Mathf.PI) % TwoPI - Mathf.PI;
        ...
        {
            public enum LineType { Inner, Center, Outer }
        ...
        public class OutlineShapeProperties : ShapeProperties
        {
            ...
            public Color32 OutlineColor = new(255, 255, 255, 255);
        ...
        {
            public enum ResolutionType { Calculated, Fixed }
        ...
        {
            public Color32 Color = new(0, 0, 0, 120);
        ...
        {
            public Color32 FillColor = new(255, 255, 255, 255);
        }

        [Serializable]
        public class SnappedPositionAndOrientationProperties
        {
            public enum OrientationTypes { Horizontal, Vertical }

            public enum PositionTypes { Center, Top, Bottom, Left, Right }
